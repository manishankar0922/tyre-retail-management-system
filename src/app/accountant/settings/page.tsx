...
import AccountantSettings from "@/components/settings/AccountantSettings";
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-zinc-400 dark:text-zinc-505 font-semibold uppercase tracking-wider">
              Configure printer layouts and terminal appearance preferences
            </p>
          </div>
        </div>
      </div>

      {/* Accountant settings form */}
